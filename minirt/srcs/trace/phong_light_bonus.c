...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2021/11/02 11:45:37 by hyson             #+#    #+#             */
/*   Updated: 2021/11/02 12:02:38 by hyson            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_color3	get_point_light_bonus(t_light *light, t_ray *r, t_rec *rec)
{
	t_vec3		light_dir;
	double		brightness;
	double		light_len;
...
t_color3	phong_lighting_bonus(t_ray *r, t_rec *rec)
{
	...
	while (lights)
	{
		point_light = get_point_light_bonus(lights->element, r, rec);
