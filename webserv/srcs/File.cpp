...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/17 14:11:07 by sanjeon           #+#    #+#             */
/*   Updated: 2022/08/18 06:02:40 by hyson            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void File::set_body_listing(std::string *body,
							...
							AutoListings *als)
{
	for (AutoListings::const_iterator it = als->begin(); it != als->end(); it++)
	{
		(*body) += "<a href=\"";
...
std::string File::get_autoindex_page(const std::string &target)
{
	DIR *dir;
	std::string body;
