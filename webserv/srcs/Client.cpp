...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/12 13:16:23 by sanjeon           #+#    #+#             */
/*   Updated: 2022/08/18 06:02:41 by sanjeon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool Client::is_timeout(void)
{
	if (_req)
	{
		...
		if (current_time - _req->get_header_time() > HEADER_TIMEOUT || current_time - _req->get_body_time() > BODY_TIMEOUT)
		{
			if (_req->is_req_recv_complete())
			{
				return true;
			}
		}
