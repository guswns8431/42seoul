...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2022/08/15 08:02:16 by sanjeon           #+#    #+#             */
/*   Updated: 2022/08/19 08:13:16 by sanjeon          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
  gettimeofday(&_header_timer, NULL);
}
...
int Request::validate_headers(void)
{
  ...
  else if (check_content_length_exist())
  {
...
int Request::parse_body(void)
{
  ...
  {
    _body.append(_data, 0, _content_length);
    _data.clear();
  ...
  else if (_data.length() > _content_length)
  {
    _data.clear();
    return 400;
  }
...
bool Request::check_content_length_exist(void) const
{
...
bool Request::is_req_recv_complete()
{
  if (!is_on_complete())
  {
    _request_status = on_error;
